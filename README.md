...
```
compile 'com.github.lewik.klog:klog-metadata:2.0.2' //for common modules
compile 'com.github.lewik.klog:klog-js:2.0.2'  //for js modules
compile 'com.github.lewik.klog:klog-jvm:2.0.2'  //for jvm modules
```
